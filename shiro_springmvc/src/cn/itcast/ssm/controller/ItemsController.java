...
public class ItemsController {
	...
	//单独将商品类型的方法提出来，将方法返回?填充到request，在页面显示
	...
	public Map<String, String> getItemsType()throws Exception{
        ...
        itemsType.put("002", "家电类");
		return itemsType;
		
	}

	@RequestMapping("/queryItem")
	@RequiresPermissions("item:query")     //执行此方法需要"item:query"权限
...
//	}
	...
	//方法返回 字符串，字符串就是翻辑视图名，Model作用是将数据填充到request域，在页面展碿
	@RequestMapping(value="/editItems",method={RequestMethod.GET})
	...
	//根据商品id查看商品信息rest接口
	//@RequestMapping中指定restful方式的url中的参数，参数需要用{}包起替
	//@PathVariable将url中的{}包起参数和形参进行绑嬿
...
//		// Date.class必须是与controler方法形参pojo属俧一致的date类型，这里是java.util.Date
