    ...
    <ul>
    	...
    	<li>
    		<a href="#" onclick="test(children[0])">订单管理
	    		<div class="dc">
	    			<a href="${pageContext.request.contextPath }/OrderServlet2?method=getAll&state=false"  target="right">待处理订单</a><br/>
	    			<a href="${pageContext.request.contextPath }/OrderServlet2?method=getAll&state=true"  target="right">已发货订单</a><br/>
	    		</div>
    		</a>
    	</li>
        ...
        <li>
            <a href="#" onclick="test(children[0])">数据库管理
                <div class="dc">
                    <a href="${pageContext.request.contextPath }/manager/dbbak.jsp"  target="right">数据库备份</a><br/>
